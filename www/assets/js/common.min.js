let Fn={},Evt={},getGeoLocation=($(()=>{document.addEventListener("touchstart",function(e){1<e.touches.length&&e.preventDefault()},{passive:!1});let s=0;document.addEventListener("touchend",function(e){var t=(new Date).getTime();t-s<=300&&(e.preventDefault(),document.body.style.transform="scale(1)",document.body.style.transformOrigin="0 0"),s=t},{passive:!1})}),Fn.doContDown=(e,n,r)=>{let i;var t=()=>{var t=Date.now(),t=e-t;if(t<=0)n.text("00:00:00"),i&&clearInterval(i),r&&r();else{var s=Math.floor(t/864e5),a=Math.floor(t/36e5%24),o=Math.floor(t/6e4%60),t=Math.floor(t/1e3%60);let e="";1<s?e+=s+"DAYS ":1===s&&(e+=s+"DAY "),e+=`${a.toString().padStart(2,"0")}:${o.toString().padStart(2,"0")}:`+t.toString().padStart(2,"0"),n.text(e)}};return t(),i=setInterval(t,1e3)},Evt.press=window.PointerEvent?"pointerdown":"ontouchstart"in window?"touchstart":"mousedown",Evt.release=window.PointerEvent?"pointerup":"ontouchstart"in window?"touchend":"mouseup",Fn.formatDistanceKm=(e=0)=>{let t=Number(e);return Number.isFinite(t)?(t=Math.abs(t)<1e-9?0:t)<1?Math.max(0,Math.round(1e3*t))+"m":Math.round(10*t)/10+"km":"---"},async(e=5,t=10)=>{let s=0,a={error_message:"現在地を取得できませんでした"};for(;s<e;)try{if((a=await new Promise((t,s)=>{navigator.geolocation.getCurrentPosition(e=>{t({lat:e.coords.latitude,lng:e.coords.longitude,accuracy:e.coords.accuracy})},e=>{switch(e.code){case e.PERMISSION_DENIED:s("位置情報のアクセスが拒否されました。");break;case e.POSITION_UNAVAILABLE:s("位置情報が利用できません。");break;case e.TIMEOUT:s("位置情報の取得がタイムアウトしました。");break;default:s("位置情報の取得に失敗しました。")}},{enableHighAccuracy:!0,timeout:1e4,maximumAge:0})})).accuracy<=t)return a;s++}catch(e){return a||{error_message:e}}return a}),getParam=e=>{e=new URLSearchParams(location.search).get(e);return e?decodeURIComponent(e):""},MAP=(Fn.getParam=e=>{e=new URLSearchParams(location.search).get(e);return e?decodeURIComponent(e):""},Fn.getSearchKeywords=(e="")=>"string"!=typeof e?[]:e.normalize("NFKC").trim().split(/\s+/).filter(Boolean),Fn.getYmdJa=(e,t="ymd")=>{var s=new Date(e);switch(t){case"d":formatted=s.getDate()+"日";break;case"md":formatted=`${s.getMonth()+1}月${s.getDate()}日`;break;case"ymdhi":formatted=`${s.getFullYear()}年${s.getMonth()+1}月${s.getDate()}日 ${String(s.getHours()).padStart(2,"0")}:`+String(s.getMinutes()).padStart(2,"0");break;default:formatted=`${s.getFullYear()}年${s.getMonth()+1}月${s.getDate()}日`}return formatted},Fn.isPastDate=(e,t,s=!1)=>{"today"===t&&(t=null);let a=(e="today"===e?null:e)?new Date(e.replace(/-/g,"/")):new Date,o=t?new Date(t.replace(/-/g,"/")):new Date;return a=a.setHours(0,0,0,0),o=o.setHours(0,0,0,0),s?a<=o:a<o},Fn.loadJson=async e=>{try{var t=await fetch(e);if(t.ok)return await t.json();throw new Error("HTTPエラー: "+t.status)}catch(e){return console.error("JSON取得失敗:",e),null}},Fn.loadJsonMultiple=async e=>await Promise.all(e.map(e=>Fn.loadJson(e))),{}),IS_LOCALSTORAGE=(MAP.markers=[],MAP.z_index=0,MAP.createMarker=({map:e,id:t,lat:s,lng:a,z_index:o,content:n,func:r})=>{e=new MAP.advaned_marker({map:e,position:{lat:s,lng:a},zIndex:o,content:n});e.addListener("click",()=>{r&&r(t)}),e._meta={id:t,lat:s,lng:a,z_index:o},MAP.markers.push({id:t,marker:e})},MAP.showMarker=t=>{var e=MAP.markers.find(e=>e.id===+t);e&&(e.marker.map=MAP.gmap)},MAP.showAllMarkers=()=>{MAP.markers.forEach(e=>{e.marker.map=MAP.gmap})},MAP.hideMarker=t=>{var e=MAP.markers.find(e=>e.id===+t);e&&(e.marker.map=null)},MAP.hideAllMarkers=()=>{MAP.markers.forEach(e=>{e.marker.map=null})},MAP.removeMarker=t=>{var e=MAP.markers.findIndex(e=>e.id===+t);e&&(MAP.markers[e].marker.map=null,MAP.markers.splice(e,1))},MAP.removeAllMarkers=()=>{MAP.hideAllMarkers(),MAP.markers=[]},MAP.animateMarker=t=>{var e,s=MAP.markers.find(e=>e.id===+t);s&&(e=(s=s.marker).content,MAP.z_index++,s.zIndex=MAP.z_index,e.classList.remove("maps-marker-pop"),e.offsetWidth,e.classList.add("maps-marker-pop"))},MAP.removeClassMarker=(t,e)=>{var s=MAP.markers.find(e=>e.id===+t);s&&s.marker.content.classList.add(e)},MAP.removeClassMarker=(t,e)=>{var s=MAP.markers.find(e=>e.id===+t);s&&s.marker.content.classList.remove(e)},MAP.addClassAllMarkers=t=>{MAP.markers.forEach(e=>{e.marker.content.classList.add(t)})},MAP.removeClassAllMarkers=t=>{MAP.markers.forEach(e=>{e.marker.content.classList.remove(t)})},MAP.getCenter=()=>{var e=MAP.gmap.getCenter();return{lat:e.lat(),lng:e.lng()}},MAP.panTo=(e,t)=>{e=MAP.normalizeLatLng(e,t);e&&MAP.gmap.panTo(e)},MAP.getCenterAfterChanged=t=>{MAP.gmap.addListener("idle",()=>{var e=MAP.getCenter();t(e.lat,e.lng)})},MAP.getAddressFromLatLng=(t,s)=>new Promise((a,e)=>{(new google.maps.Geocoder).geocode({location:{lat:t,lng:s}},(t,s)=>{if("OK"===s&&t[0]){let e=t[0].formatted_address;e.startsWith("日本")&&(e=(e=(e=(e=(e=e.replace(/^日本、?/,"")).replace(/〒\d{3}-\d{4}\s*/,"")).split(/[ー−-]/)[0]).trim()).replace(/[０-９]/g,e=>String.fromCharCode(e.charCodeAt(0)-65248))),a({status:s,str:e})}else e({status:s})})}),MAP.normalizeLatLng=(e,t)=>{e=Number(e),t=Number(t);return!Number.isFinite(e)||!Number.isFinite(t)||e<-90||90<e||t<-180||180<t?null:{lat:e,lng:t}},Fn.mapGetDistance=(e,t,s,a)=>{var o=e=>e*Math.PI/180,n=o(s-e),a=o(a-t),t=Math.sin(n/2)*Math.sin(n/2)+Math.cos(o(e))*Math.cos(o(s))*Math.sin(a/2)*Math.sin(a/2);return 6371*(2*Math.atan2(Math.sqrt(t),Math.sqrt(1-t)))},Fn.matchByKeywords=(e="",t=[],s="AND")=>{if(!Array.isArray(t)||0===t.length)return!0;let a=e||"",o="OR"===s?"OR":"AND";return"AND"==o?t.every(e=>a.includes(Fn.textNormalizeForSearch(e))):t.some(e=>a.includes(Fn.textNormalizeForSearch(e)))},$(()=>{$(document).on(Evt.release,".js-propagation",e=>{e.stopPropagation()})}),Fn.setLang=()=>{var e=navigator.language.startsWith("ja")?"ja":"en";$("html").attr("lang",e)},Fn.shuffle=(e=[],t)=>{var s=t?e:[...e];let a,o;for(a=s.length;1<a;a--)o=Math.floor(Math.random()*a),[s[o],s[a-1]]=[s[a-1],s[o]];return s},Fn.slide={},Fn.slide.is_touch="ontouchstart"in window&&"ontouchend"in window||navigator.msPointerEnabled,Fn.slide.start=Fn.slide.is_touch?"touchstart":"mousedown",Fn.slide.move=Fn.slide.is_touch?"touchmove":"mousemove",Fn.slide.end=Fn.slide.is_touch?"touchend":"mouseup",Fn.slide.leave=Fn.slide.is_touch?"touchleave":"mouseleave",Fn.slide.is_session="sessionStorage"in window&&null!==window.sessionStorage,Fn.slide.storage=(t,e)=>{let s=null;if(Fn.slide.is_session&&void 0!==t)if(void 0!==e)sessionStorage[t]="object"==typeof e?JSON.stringify(e):e;else try{s=new Function("return "+sessionStorage[t])()}catch(e){s=sessionStorage[t]}return s},Fn.slide.storageDel=e=>{sessionStorage.removeItem(e)},Fn.slide.show=(s=".slideshow",e={})=>{let a=$(s),o=$(".slideshow__flex",a),t=$(".slideshow__unit",a),n=$(".js-slide-nav",a),r=$("a",n),i=e.t?$(".js-slide-link",e.t):$(".js-slide-link"),l=e.interval||!1===e.interval?e.interval:3e3,c=e.before,p=e.after,d=e.click,u=e.is_keyboard,h=[],m,g,v,f,j=0,_=e.no||1,w,k,b,y,P,E,S,A,M,F=t.width(),L=(0===F&&setTimeout(()=>{F=t.width()},1),Fn.slide.storage(s)&&(_=Fn.slide.storage(s),Fn.slide.storageDel(s)),$("img",a).attr("draggable","false"),()=>{var e=t.width();c&&c(),0!=e&&(F=e),o.stop().animate({left:F*(_-1)*-1},()=>{p&&p()}),C()}),C=()=>{1<t.length?(a.attr("data-no",_),0<r.length&&(r.removeClass("on"),$('[data-nav="'+_+'"]',a).addClass("on"))):n.remove()},R=e=>{switch(e){case"next":(_+=1)>j&&(_=1);break;case"prev":(_-=1)<1&&(_=j)}},T=()=>{f&&clearTimeout(f),f=setTimeout(()=>{g&&(R("next"),L()),T()},l)};!u&&1!==$(".slideshow").length||document.addEventListener("keydown",e=>{switch(e.key){case"ArrowLeft":l&&T(),R("prev"),L();break;case"ArrowRight":l&&T(),R("next"),L()}return!1}),$(window).on("resize",()=>{F=t.width(),o.css("left",F*(_-1)*-1)}),r.on("click",function(){var e=$(this).attr("data-nav")||"next";return g=!1,"prev"===e||"next"===e?R(e):_=+e,L(),!1}),i.on("click",function(){var e=$(this).attr("data-nav")||"next";return g=!1,"prev"===e||"next"===e?R(e):_=+e,L(),!1});j=t.length,t.each(function(){var e=$(this).attr("data-href");e&&""!=e?h.push(e):h.push(null)}),o.css("left",F*(_-1)*-1),C(),(()=>{let t=()=>{m=!1,v&&clearTimeout(v),v=setTimeout(()=>{!m&&l&&(g=!0)},l)};a.on(Fn.slide.start,e=>{m=!1,g=!1,w=(Fn.slide.is_touch?e.touches[0]:e).pageX,k=(Fn.slide.is_touch?e.touches[0]:e).pageY,b=w,y=k}).on(Fn.slide.end,e=>{S=b-P,A=y-E,m?(Math.abs(A)<50&&(50<S?R("next"):S<-50&&R("prev"),L(),e.preventDefault()),t()):(d&&d(),h[_-1]&&(Fn.slide.storage(s,_),location.href=h[_-1]))}).on(Fn.slide.leave,t).on(Fn.slide.move,e=>{m=!0,P=(Fn.slide.is_touch?e.touches[0]:e).pageX,E=(Fn.slide.is_touch?e.touches[0]:e).pageY,S=b-P,A=y-E,50<Math.abs(S)&&(o.css({left:M-(w-P)}),w=P,e.preventDefault())})})(),l&&(g=!0,T())},"localStorage"in window&&null!==window.localStorage),IS_SESSIONSTORAGE="sessionStorage"in window&&null!==window.sessionStorage,Photos=(Fn.storageLS=(t,e)=>{let s=null;if(IS_LOCALSTORAGE&&void 0!==t)if(void 0!==e)localStorage[t]="object"==typeof e?JSON.stringify(e):e;else try{s=new Function("return "+localStorage[t])()}catch(e){s=localStorage[t]}return s},Fn.storageDelLS=e=>{localStorage.removeItem(e)},Fn.storageSS=(t,e)=>{let s=null;if(IS_SESSIONSTORAGE&&void 0!==t)if(void 0!==e)sessionStorage[t]="object"==typeof e?JSON.stringify(e):e;else try{s=new Function("return "+sessionStorage[t])()}catch(e){s=sessionStorage[t]}return s},Fn.storageDelSS=e=>{sessionStorage.removeItem(e)},Fn.textNormalizeForSearch=(e="")=>"string"!=typeof e?"":e.normalize("NFKC").toLowerCase().replace(/[\u30a1-\u30f6]/g,e=>String.fromCharCode(e.charCodeAt(0)-96)).replace(/ー/g,"").replace(/\s+/g,"").replace(/ゔぁ/g,"ば").replace(/ゔぃ/g,"び").replace(/ゔぇ/g,"べ").replace(/ゔぉ/g,"ぼ").replace(/ゔ/g,"ぶ").replace(/[・,，.．]/g,""),Fn.uploader=(o={})=>{let f={concurrency:3,endpoint:"/assets/api/uploader.php",fadeout_duration:400,max_filesize:-1048576,allowed_types:["image/jpeg","image/png","image/gif","image/webp","image/heic","image/heif"]},j="再試行",i={waiting:"アップロードボタンのクリック待ち",uploading:"アップロード中",done:"アップロード完了しました",error:"エラーが発生しました",403:"セッションが切れました。再読み込みしてください",413:"ファイルサイズが大きすぎます",CSRF_INVALID:"セッションが切れました。再読み込みしてください",METHOD_NOT_ALLOWED:"不正なリクエストです",NO_DIRECTORY:"アップロード先が不明です",NO_FILE:"ファイルが選択されていません",TIMEOUT_ERROR:"通信がタイムアウトしました",UPLOAD_ERROR:"アップロードに失敗しました",SERVER_CONNECT_ERROR:"サーバーに接続できませんでした",INVALID_TYPE:"対応していないファイルです",UPLOAD_ERR_CANT_WRITE:"アップロードできませんでした。指定先の書き込み権限がないようです。",UPLOAD_ERR_EXTENSION:"アップロードできませんでした。セキュリティ問題が発生しているようです。",FILE_TOO_LARGE:"ファイルサイズが大きすぎます",MOVE_FAILED:"サーバーエラーが発生しました",OTHER:"不正なレスポンスです"},_=(()=>{let h={files:[],active_count:0},m=(e,t,s="")=>{e.status=t,e.error_code=s,v(e)},t=()=>{var e=h.files.some(e=>"uploading"===e.status),t=h.files.some(e=>"waiting"===e.status),s=h.files.some(e=>"done"===e.status);!e&&!t&&s&&o.func&&o.func()};let n=()=>{for(;h.active_count<f.concurrency;){var e=h.files.find(e=>"waiting"===e.status);if(!e)return;s(e)}},s=s=>{let a=new XMLHttpRequest,e=new FormData,o=(e.append("image",s.file),e.append("csrf_token",CSRF_TOKEN),e.append("category",CATEGORY),m(s,"uploading"),h.active_count++,a.upload.addEventListener("progress",e=>{e.lengthComputable&&(s.progress=Math.min(96,Math.round(e.loaded/e.total*100)),v(s))}),a.responseType="json",a.timeout=3e4,()=>{h.active_count--,r(),n(),t()});a.addEventListener("load",()=>{(()=>{var e=a.response;let t;"success"===e?.status?(s.progress=100,m(s,"done")):(t="error"===e?.status?e.code||"UPLOAD_ERROR":400<=a.status?a.status:"OTHER")&&(s.progress=0,m(s,"error",t)),o()})()}),a.addEventListener("error",()=>{m(s,"error","SERVER_CONNECT_ERROR"),o()}),a.addEventListener("timeout",()=>{m(s,"error","TIMEOUT_ERROR"),o()}),a.open("POST",f.endpoint),a.send(e)},g=t=>{t.el.classList.add("is-fadeout"),setTimeout(()=>{t.preview_url&&URL.revokeObjectURL(t.preview_url),t.el.remove(),h.files=h.files.filter(e=>e!==t)},f.fadeout_duration)},a=e=>"error"===e.status&&e.error_code?i[e.error_code]||e.error_code:i[e.status]||e.status,v=e=>{e.barEl.style.width=e.progress+"%",e.statusEl.textContent=a(e),e.el.className="uploader-filecard is-"+e.status,e.updateButton?.(),"done"===e.status&&g(e)},r=()=>{c.disabled=!h.files.some(e=>"waiting"===e.status)};return{addFiles:(e,{auto_start:t=!1}={})=>{Array.from(e).forEach(e=>{var t={id:crypto.randomUUID(),file:e,status:"waiting",progress:0,error_code:""};switch(!0){case 0===e.size:t.status="error",t.error_code="NO_FILE";break;case 0<f.max_filesize&&e.size>f.max_filesize:t.status="error",t.error_code="FILE_TOO_LARGE";break;default:var s=e.name.toLowerCase();f.allowed_types.includes(e.type)||s.endsWith(".heic")||s.endsWith(".heif")?t.preview_url=URL.createObjectURL(e):(t.status="error",t.error_code="INVALID_TYPE")}h.files.push(t),l.appendChild((a=>{const e=document.createElement("div"),t=document.createElement("div"),s=document.createElement("div"),o=document.createElement("div"),n=document.createElement("img"),r=document.createElement("div"),i=document.createElement("div"),l=document.createElement("div"),c=document.createElement("button"),p=document.createElement("div"),d=document.createElement("div"),u=(e.className=`uploader-filecard is-${a.status}`,t.className="uploader-text",s.className="uploader-name",o.className="uploader-thumbnail",r.className="uploader-filecardprogress",i.className="uploader-filecardbar",l.className="uploader-filecardstatus",c.type="button",c.textContent=j,p.className="uploader-delete",d.className="uploader-delete-button",s.textContent=a.file.name,n.onerror=()=>{n.remove();o.classList.add("uploader-nothumbnail");o.onclick=()=>{g(a)}},n.src=a.preview_url,()=>{if(a.status==="error"){c.onclick=()=>{a.status="waiting";a.error_code="";v(a);_.processQueue()};_.uploadFile=e=>{const t=new XMLHttpRequest;const s=new FormData;s.append("image",a.file);s.append("csrf_token",CSRF_TOKEN);m(a,"uploading");h.active_count++;t.responseType="json";t.timeout=3e4;t.addEventListener("load",()=>{const e=t.response;if(e?.status==="success")m(a,"done");else m(a,"error",e?.code||"UPLOAD_ERROR");h.active_count--;u();_.processQueue()});t.addEventListener("error",()=>{m(a,"error","SERVER_CONNECT_ERROR");h.active_count--;u();_.processQueue()});t.open("POST",f.endpoint);t.send(s)};_.processQueue()}});return d.onclick=()=>g(a),u(),r.appendChild(i),p.appendChild(d),o.appendChild(n),t.appendChild(s),t.appendChild(r),t.appendChild(l),e.appendChild(p),e.appendChild(o),e.appendChild(t),e.appendChild(c),a.el=e,a.barEl=i,a.statusEl=l,a.updateButton=u,v(a),e})(t))}),r(),t&&n()},processQueue:n}})(),l=document.querySelector(".js-uploader-filelist"),t=document.querySelector(".js-uploader-droparea"),e=document.querySelector(".js-uploader-input"),c=document.querySelector(".js-uploader-button");t.addEventListener("click",()=>e.click()),e.addEventListener("change",e=>{_.addFiles(e.target.files,{auto_start:!1})}),t.addEventListener("dragover",e=>{e.preventDefault(),t.classList.add("is-dragover")}),t.addEventListener("dragleave",()=>{t.classList.remove("is-dragover")}),t.addEventListener("drop",e=>{e.preventDefault(),t.classList.remove("is-dragover"),_.addFiles(e.dataTransfer.files,{auto_start:!0})}),c.addEventListener("click",()=>{_.processQueue()})},{}),getCreateUser=(Photos.likes={},Photos.ls=Fn.storageLS("photowalk")||{},"undefined"==typeof PARAM_EVENT_ID&&(PARAM_EVENT_ID=""),$(()=>{$(".js-page").html(page_init),""!=PARAM_EVENT_ID?$('.js-form-event input[name="id"]').val(PARAM_EVENT_ID):Photos.ls.event_id&&$('.js-form-event input[name="id"]').val(Photos.ls.event_id),$(document).on("click",".js-link-end",()=>{var e=Fn.getParam("event_id");return location.href=""!=e?"./report.php?event_id="+e:"./",!1})}),document.addEventListener("contextmenu",async e=>{await(await fetch("/assets/api/csrf_token_for_img.php")).json()}),Fn.setLang(),$(()=>{$(document).on("submit",".js-form-event",function(){let e=$(this),l=$(".js-form-error",e),t=$('[name="id"]',e),c=t.val();return l.html("").css({visibility:"hidden"}),(async()=>{try{var e=await getEventInfoWithImages(c),t=new URLSearchParams(window.location.search);if("success"!=e.status)return!l.html(e.message).css({visibility:"visible"});Photos.event_id=c,Photos.photowalkers=e.photowalkers,Photos.ls.event_id=c,Fn.storageLS("photowalk",Photos.ls),t.set("event_id",c),history.replaceState(null,"","?"+t.toString());var s=1e3*+e.date,a=Fn.getYmdJa(s),o=new Intl.DateTimeFormat("en-US",{year:"numeric",month:"short",day:"numeric"}).format(s),n=1e3*+e.vote_counting_at,r=Fn.getYmdJa(n,"ymdhi"),i=new Intl.DateTimeFormat("en-US",{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!1}).format(n);$(".js-page").html(page_account).hide(),$(".js-account-title .ja").text(e.title_ja),$(".js-account-title .en").text(e.title_en),$(".js-account-time .ja").text(a),$(".js-account-time .en").text(o),$(".js-account-limited-time .ja").text(r),$(".js-account-limited-time .en").text(i),$(".js-account-excerpt .ja").text(e.excerpt_ja),$(".js-account-excerpt .en").text(e.excerpt_en),$(".js-page").show(),Photos.ls.public_id&&$('.js-form-account input[name="display_name"]').val(Photos.ls.public_id)}catch(e){return!$(".js-page").html(page_error)}})(),!1}),$(document).on("click",".js-account-firsttime",()=>{$('.js-account[data-flow="1"]').hide(),$('.js-account[data-flow="2-1"]').show()}),$(document).on("click",".js-account-returning",()=>{$('.js-account[data-flow="1"]').hide(),$('.js-account[data-flow="2-2"]').show()}),$(document).on("click",".js-link-account",()=>{$(".js-account").hide(),$('.js-account[data-flow="1"]').show()}),$(document).on("click",".js-account-create",function(){$(this).replaceWith(`
    ...
    `),(async()=>{try{var e=await getCreateUser();if("success"!=e.status)return!$(".js-page").html(page_error);Photos.handle=e.public_id,Photos.ls.public_id=e.public_id,Fn.storageLS("photowalk",Photos.ls),$(".js-account-create-number").replaceWith(`
          <p><strong>${e.public_id}</strong></p>
