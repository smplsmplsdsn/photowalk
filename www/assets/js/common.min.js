...
`,setEventInfo=e=>(e.append("csrf_token",CSRF_TOKEN),$.ajax({url:"./assets/api/set_event_info.php",method:"POST",dataType:"json",data:e,processData:!1,contentType:!1})),setLikes=(e={})=>(e.csrf_token=CSRF_TOKEN,console.log(e),$.ajax({url:"./assets/api/likes.php",method:"POST",dataType:"json",data:e}));