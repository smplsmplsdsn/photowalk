...
`,setEventInfo=s=>(s.append("csrf_token",CSRF_TOKEN),$.ajax({url:"./assets/api/set_event_info.php",method:"POST",dataType:"json",data:s,processData:!1,contentType:!1})),setLikes=(s={})=>(s.csrf_token=CSRF_TOKEN,$.ajax({url:"./assets/api/likes.php",method:"POST",dataType:"json",data:s}));